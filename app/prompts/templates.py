...
# System Prompts
QA_SYSTEM_PROMPT = "You are a helpful question-answering assistant. Answer questions clearly."

SUMMARIZATION_SYSTEM_PROMPT = "You are a summarization assistant. Create concise summaries."

CALCULATION_SYSTEM_PROMPT = "You are a mathematical calculation assistant. Solve problems step-by-step."
